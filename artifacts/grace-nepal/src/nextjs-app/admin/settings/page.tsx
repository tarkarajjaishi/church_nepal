...
function ServiceTimesTab() {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      if (editId) {
        // @ts-ignore
        await updateMut.mutateAsync({ id: editId, name: form.name, nameNe: form.nameNe, day: form.day, time: form.time, icon: form.icon, sortOrder: form.sortOrder })
        toast.success('Service time updated')
      } else {
        // @ts-ignore
        await createMut.mutateAsync({ name: form.name, nameNe: form.nameNe, day: form.day, time: form.time, icon: form.icon, sortOrder: form.sortOrder })
