...
pub async fn get(State(pool): State<PgPool>, Path(id): Path<uuid::Uuid>) -> Result<Json<Todo>, AppError> {
...
pub async fn create(_auth: AuthUser, State(pool): State<PgPool>, Json(input): Json<CreateTodo>) -> Result<Json<Todo>, AppError> {
...
pub async fn update(_auth: AuthUser, State(pool): State<PgPool>, Path(id): Path<uuid::Uuid>, Json(input): Json<UpdateTodo>) -> Result<Json<Todo>, AppError> {
...
pub async fn toggle_status(_auth: AuthUser, State(pool): State<PgPool>, Path(id): Path<uuid::Uuid>) -> Result<Json<Todo>, AppError> {
    let row = sqlx::query_as::<_, Todo>(
...
pub async fn reorder(_auth: AuthUser, State(pool): State<PgPool>, Path(id): Path<uuid::Uuid>, Json(input): Json<ReorderRequest>) -> Result<Json<Todo>, AppError> {
