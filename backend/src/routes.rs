...
fn public_routes() -> Router {
    Router::new()
        ...
        .route("/prayer-requests/{id}/pray", post(prayer_requests::pray))
        .route("/broadcasts/open/{broadcast_id}/{recipient_id}", get(broadcasts::mark_opened))
...
fn admin_routes() -> Router {
    Router::new()
        ...
        .route("/members/bulk/household", post(members::bulk_set_household))
        .route("/members/bulk/tag", post(members::bulk_assign_tag))
        .route("/members/households", get(members::list_households).post(members::create_household))
        .route("/members/households/{id}", get(members::get_household).put(members::update_household).delete(members::delete_household))
        .route("/members/tags", get(members::list_tags).post(members::create_tag))
        .route("/members/tags/{id}", delete(members::delete_tag))
        .route("/members/{id}/tags", get(members::list_member_tags))
        .route("/members/{id}/tags/{tag_id}", post(members::add_member_tag).delete(members::remove_member_tag))
        .route("/members/{id}/notes", get(members::list_member_notes).post(members::create_member_note))
        .route("/members/{id}/notes/{note_id}", delete(members::delete_member_note))
        .route("/members/{id}/custom-fields", get(members::list_member_custom_fields).post(members::set_member_custom_field))
        .route("/members/{id}/custom-fields/{field_id}", delete(members::delete_member_custom_field))
        // Service Times
        ...
        .route("/campaigns/{id}/recalc-raised", post(campaigns::recalc_raised))
        // Settings (writes)
        .route("/settings/{key}", put(settings::upsert))
        .route("/settings/sections/{section}/toggle", put(settings::toggle_section))
        .route("/settings/theme/draft", get(settings::get_theme_draft).put(settings::save_theme_draft))
        ...
        .route("/donations/{id}/resend-receipt", post(donations::resend_receipt))
        ...
        .route("/contact-messages/{id}", get(contact_messages::get).put(contact_messages::update).delete(contact_messages::delete))
        ...
        .route("/broadcasts/{id}", get(broadcasts::get).put(broadcasts::update).delete(broadcasts::delete))
        .route("/broadcasts/{id}/send", post(broadcasts::send))
        .route("/broadcasts/{id}/schedule", post(broadcasts::schedule))
        .route("/broadcasts/{id}/stats", get(broadcasts::stats))
        .route("/broadcasts/{id}/recipients", get(broadcasts::list_recipients))
        // Forms
        ...
        .route("/recurring-donations", get(donations::list_recurring).post(donations::create_recurring))
        .route("/recurring-donations/{id}", get(donations::get_recurring))
        .route("/recurring-donations/{id}/pause", post(donations::pause_recurring))
        .route("/recurring-donations/{id}/cancel", post(donations::cancel_recurring))
        // Pledges
        ...
        .route("/member-applications/{id}/approve", put(member_applications::approve))
        .route("/member-applications/{id}/reject", put(member_applications::reject))
        // Prayer Requests (admin moderation)
        .route("/prayer-requests", get(prayer_requests::list_all))
        .route("/prayer-requests/{id}", get(prayer_requests::get).put(prayer_requests::update).delete(prayer_requests::delete))
        .route("/prayer-requests/{id}/approve", put(prayer_requests::approve))
        .route("/prayer-requests/{id}/reject", put(prayer_requests::reject))
}
