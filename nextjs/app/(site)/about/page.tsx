...
export default function About() {
  ...
  return (
    <div>
      <PageHero title={hero?.title || "About Our Church"} crumb="About" image={hero?.items?.[0]?.image || images.crowd}
        subtitle={hero?.subtitle || "A Christ-centred family growing in faith, hope and love since 2008."} />
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
          <Reveal>
            <ImageWithFallback src={history.items?.[0]?.image || images.study2} alt="Our church family" className="rounded-3xl w-full aspect-[4/3] object-cover shadow-xl" />
          </Reveal>
          <div>
            <SectionHeading center={false} eyebrow="Our Story" title={history.title || "Church History"} subtitle={history.subtitle || ""} />
          </div>
        </div>
      </section>
      )}
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4">
          <SectionHeading eyebrow="What Drives Us" title={values.title || "Core Values"} />
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-4">
          <SectionHeading eyebrow="Questions" title={faq.title || "Frequently Asked"} />
          <Reveal delay={0.1}>
