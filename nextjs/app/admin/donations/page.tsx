    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: 'eSewa Total', value: `Rs ${(stats.esewaTotal || 0).toLocaleString()}`, icon: CreditCard, color: 'bg-purple-500' },
          { label: 'Khalti Total', value: `Rs ${(stats.khaltiTotal || 0).toLocaleString()}`, icon: CreditCard, color: 'bg-red-500' },
