  ...
  return (
    <div className="fixed right-4 bottom-4 z-40 flex flex-col gap-3">
      <Link href="/prayer"
        ...
        aria-label={(items.prayerLabel ?? items.prayer_label) || "Request prayer"}
        title={(items.prayerLabel ?? items.prayer_label) || "Request Prayer"}
      >
      ...
      <a
        ...
        aria-label={(items.whatsappLabel ?? items.whatsapp_label) || "WhatsApp"}
        title={(items.whatsappLabel ?? items.whatsapp_label) || "WhatsApp"}
        target="_blank"
      ...
      <a
        ...
        aria-label={(items.callLabel ?? items.call_label) || "Call us"}
        title={(items.callLabel ?? items.call_label) || "Call"}
      >
