    ...
    return (
      <div className="py-32">
        ...
        <div className="text-center mt-4">
          <Button asChild variant="outline"><Link to="/sermons"><ArrowLeft className="size-4" /> {t("back_to_sermons")}</Link></Button>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="py-32 text-center">
        ...
        <Button asChild className="mt-6 bg-church-blue hover:bg-church-blue/90">
          <Link to="/sermons"><ArrowLeft className="size-4" /> {t("back_to_sermons")}</Link>
        </Button>
      </div>
    );
  }
