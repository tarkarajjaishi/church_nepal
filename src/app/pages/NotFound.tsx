    ...
    <section className="relative min-h-[80vh] grid place-items-center">
      ...
      <div className="relative text-center text-white px-4">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg" className="bg-gold text-church-blue hover:bg-gold/90"><Link to="/"><Home className="size-4" /> Back Home</Link></Button>
          <Button asChild size="lg" variant="outline" className="border-white/40 text-white bg-white/5 hover:bg-white/15 hover:text-white"><Link to="/ministries"><Compass className="size-4" /> Explore Ministries</Link></Button>
        </div>
      </div>
    </section>
  );
