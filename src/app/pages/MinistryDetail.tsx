    ...
    return (
      <div className="py-32">
        ...
        <div className="text-center mt-4">
          <Button asChild variant="outline"><Link to="/ministries"><ArrowLeft className="size-4" /> {t("back_to_ministries")}</Link></Button>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="py-32 text-center">
        ...
        <Button asChild className="mt-6 bg-church-blue hover:bg-church-blue/90">
          <Link to="/ministries"><ArrowLeft className="size-4" /> {t("back_to_ministries")}</Link>
        </Button>
      </div>
    );
  }
              ...
              <Reveal delay={0.2}>
                <Card className="p-6 border-border/60">
                  ...
                  <Button asChild className="mt-6 w-full bg-church-blue hover:bg-church-blue/90">
                    <Link to="/contact">{t("join_ministry")} <ArrowRight className="size-4" /></Link>
                  </Button>
                </Card>
              </Reveal>
            </div>
