...
export default function Sermons() {
  ...
  return (
    <div>
      <PageHero title="Sermons" crumb="Sermons" image={images.praise}
        subtitle="Be encouraged and equipped by God's Word — watch, listen or read at your convenience." />
            ...
            <div className="flex items-center gap-3">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  placeholder="Search by title, speaker, series, or description..."
                  className="pl-9"
                />
                {query && (
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">No sermons found</h3>
