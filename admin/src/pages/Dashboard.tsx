            ...
            {contentSections.map(({ label, count, icon: Icon, color, link, items, renderItem }) => (
              <div key={label} className="bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                  ...
                  <Link to={link} className="text-sm text-[#0b3c5d] hover:underline flex items-center gap-1">
          ...
          {users.data && users.data.length > 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <Link to="/users" className="text-sm text-[#0b3c5d] hover:underline flex items-center gap-1">
